const tableUrl = "/api/AttendanceData/GetMonCost";
...
function excelExport() {
    ...
    let swage = $("#swage").val(); let bwage = $("#bwage").val();
    let excelUrl = "/api/CostExport/GetExportMonData?part="+part+"&worker=" + worker + "&workSite=" + workSite +
        "&year=" + year + "&mon=" + mon +"&swageStr=" + swage + "&bwageStr=" + bwage;
    ...
    oReq.onload = function () {
        ...
        var fileName = "月度成本明细_" + workSite + `_${new Date().toLocaleDateString()}.xls`; // 保存的文件名
